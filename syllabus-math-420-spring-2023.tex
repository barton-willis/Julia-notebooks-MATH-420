...
\newcommand{\meetingtime}{This class meets Monday, Wednesday, and Friday  from 
	9:05\PM{}  --  9:55 \PM}
\newcommand{\ay}{2023}
\newcommand{\finaldateandtime}{Wednesday 17, May  from 8:00\AM{}--10:00\PM}
...
\begin{mypar}{0.25in}{0.25in} 
      ...
      \textbf{First Homework due} \dotfill  \textbf{Saturday, \printdate{4/2/\the\year}}  \\
       \textbf{Exam 1} \dotfill \textbf{Friday, \printdate{24/2/\the\year}}  \\
    \textbf{Exam 2} \dotfill  \textbf{Friday, \printdate{31/3/\the\year}} \\
    \textbf{Exam 3} \dotfill \textbf{Friday, \printdate{5/4/\the\year}} \\
         \textbf{Final exam} \dotfill  \textbf{Wednesday, \printdate{17/5/\the\year}}
\end{mypar}
...
\subsubsection*{Grading}
 ...
 \begin{mypar}{0.25in}{0.25in}
       \textbf{Homework}  \emph{10 fifteen point assignments}  \dotfill 150 (total) \\
