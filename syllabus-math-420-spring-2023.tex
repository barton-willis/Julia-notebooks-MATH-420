...
=======
\newcommand{\finaldate}{Wednesday, 17 May }
...
=======
      \textbf{First Homework due} \dotfill  \textbf{Saturday, \printdate{4/2/\ay}}  \\
       \textbf{Exam 1} \dotfill \textbf{Friday, \printdate{24/2/\ay}}  \\
    \textbf{Exam 2} \dotfill  \textbf{Friday, \printdate{31/3/\ay}} \\
    \textbf{Exam 3} \dotfill \textbf{Friday, \printdate{5/4/\ay}} \\
         \textbf{Final exam} \dotfill  \textbf{\finaldate}
>>>>>>> Stashed changes
\end{mypar}
...
\begin{alphalist} 
 ...
 %  \item Reporting Student Sexual Harassment, Sexual Violence or Sexual Assault, 
 %  \item Students with Disabilities, Students Who are Pregnant
 %  \item UNK Statement of Diversity \& Inclusion,  
\end{alphalist}
